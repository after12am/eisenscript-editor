...
var defaultCode = decode('nY9LDoMwDET3PsVI7LpACahUHCcBQz+USAlIfMTd60Rwga4sz3ie7cATvmZx9s3NFKArpRTRjoBcw0DlJYKZpN5xoPevsWVPQULWNJ/eu3lskXVdR+Tnga8J7ASUFW7Y4TdohVUQWhCXuEZRnLyAFauu8YQuZGCxbqHjxMUmseJBOgFkQ5uEGHugcYPzyJg5XRsJfwHkhfPdE/AD');
...
buttonShare.addEventListener( 'click', function ( event ) {
  ...
  dom.value = 'http://' + host + '/#B/' + encode( codemirror.getValue() );
